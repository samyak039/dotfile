import dracula.draw
# Autogeneratedconfig.py
#
# NOTE:config.py is intended for advanced users who are comfortable
# with manually migrating the config file on qutebrowser upgrades. If
# you prefer, you can also configure qutebrowser using the
# :set/:bind/:config-* commands without having to write aconfig.py
# file.
#
# Documentation:
...
## Type: QtColor
c.colors.tabs.pinned.even.bg = '#50fa7b'
#
...
## Type: QtColor
c.colors.tabs.pinned.odd.bg = '#50fa7b'
#
...
# Type: String
c.content.headers.accept_language = 'en-IN,en;q=0.9'
...
#c.content.user_stylesheets = ['~/.config/everything-css/css/dracula/dracula-all-sites.css']
...
# Type: String
c.hints.border = '1px solid #BD93F9'
...
c.spellcheck.languages = ['en-GB', 'hi-IN']
...
c.statusbar.widgets = ['keypress', 'url', 'scroll_raw', 'history', 'progress']
...
# for a blank page.
# Type: FuzzyUrl
c.url.default_page = '/home/samyak039/.config/startpages/simpleClock/index.html'
...
c.url.start_pages = ['/home/samyak039/.config/startpages/simpleClock/index.html']
...
# Type: FormatString
c.window.title_format = '{private}qute{title_sep}{current_title}'
...
#config.bind('<Ctrl-R>', 'config-cycle content.user_stylesheets "~/.config/everything-css/css/dracula/dracula-all-sites.css" "~/.config/everything-css/css/apprentice/apprentice-all-sites.css" "~/.config/everything-css/css/darculized/darculized-all-sites.css" "~/.config/everything-css/css/gruvbox/gruvbox-all-sites.css" "~/.config/everything-css/css/solarized-dark/solarized-dark-all-sites.css" "~/.config/everything-css/css/solarized-light/solarized-light-all-sites.css" ""')
